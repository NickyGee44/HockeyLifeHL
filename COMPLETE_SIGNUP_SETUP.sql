-- Complete signup infrastructure setup
...
-- ============================================================================
-- 2. CREATE signup_league_with_owner FUNCTION
-- ============================================================================
-- This function creates league, profile, and membership in one transaction
...
BEGIN
  -- Start transaction
  BEGIN
    -- 1. Ensure profile exists (should be auto-created by trigger, but just in case)
    ...
    -- 3. Create league membership (owner role)
...
-- ============================================================================
-- 3. CONFIRM EMAIL FUNCTION (from before)
-- ============================================================================
