...
const supabase = createClient(
  'https://ntplczcmhvfkijjxavdl.supabase.co',
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im50cGxjemNtaHZma2lqanhhdmRsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2ODI3OTQwNywiZXhwIjoyMDgzODU1NDA3fQ.hza-FltTs_UZzH1nEpKUSZpAvVD7DvsKoOsPI8QFj3M'
);
