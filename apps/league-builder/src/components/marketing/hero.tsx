...
export function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            <div className="relative z-10 w-full max-w-6xl mx-auto px-6 pb-4 md:pb-32 mt-auto md:mt-0">
                <div className="max-w-3xl space-y-4 md:space-y-6">
                    <h1 className="hero-element font-heading text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white leading-[0.95] md:leading-[0.9]">
                        THE OPERATING SYSTEM <br className="hidden md:block" />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-ice to-steel block mt-2 md:mt-0">FOR BEER LEAGUE HOCKEY.</span>
                    </h1>
                    ...
                    <div className="hero-element flex flex-col w-full sm:w-auto sm:flex-row items-stretch sm:items-center gap-4 pt-4 md:pt-6">
                        ...
                        <a
                            href="#platform"
                            className="inline-flex items-center justify-center px-8 py-3.5 md:py-4 text-sm md:text-base font-semibold text-white border border-white/20 rounded-full hover:bg-white/10 hover:-translate-y-[1px] transition-all duration-300 w-full sm:w-auto"
                        >
                            See How It Works
                        </a>
                    </div>
                    ...
                    <div className="hero-element flex flex-wrap gap-2 pt-4 md:pt-8">
                        {['Registrations', 'Payments', 'Schedules', 'Standings', 'Public Websites'].map((chip) => (
                            <span
                                key={chip}
                                className="px-2.5 py-1 text-[10px] md:text-xs font-mono text-neutral-400 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm"
                            >
                                {chip}
                            </span>
                        ))}
