      ...
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        ...
        >
          <Input
            ...
            onChange={(event) =>
              setFormState((current) => ({ ...current, sourceSystem: event.target.value }))
            }
        ...
        >
          <Input
            ...
            onChange={(event) =>
              setFormState((current) => ({ ...current, desiredLaunchDate: event.target.value }))
            }
        ...
        >
          <Input
            ...
            onChange={(event) =>
              setFormState((current) => ({ ...current, estimatedItemCount: event.target.value }))
            }
            placeholder="2500"
            className="border-white/10 bg-black/20 text-white placeholder:text-neutral-500"
            disabled={!!activeRequest && !editableRequest}
      ...
      <div className="mt-5 grid gap-5">
        ...
        >
          <Textarea
            ...
            onChange={(event) =>
              setFormState((current) => ({ ...current, assetLinksText: event.target.value }))
            }
