    ...
    <div className="space-y-6">
      ...
      <Card className="bg-neutral-800/50 border-gold-500/20">
        ...
        <CardContent className="space-y-4">
          <div className="bg-neutral-900/50 border border-gold-500/20 rounded-xl p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Globe className="h-4 w-4 text-neutral-400" />
                <span className="font-mono text-gold-500">{subdomainUrl}</span>
              </div>
              <div className="flex items-center gap-2">
                <button
      ...
      <Card className="bg-neutral-800/50 border-gold-500/20">
        ...
        <CardContent className="space-y-4">
          {hasCustomDomainAccess ? (
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={cn(
                      'flex-1 px-4 py-2 bg-black/50 border border-gold-500/30 rounded-xl',
            ...
            <div className="bg-gradient-to-br from-gold-500/10 to-gold-600/5 border border-gold-500/30 rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Button
                    className="bg-gradient-to-r from-gold-500 to-gold-600 text-black font-semibold"
                    asChild
                  >
                    <a href="mailto:support@hockeylifehl.com?subject=Custom Domain Setup">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-neutral-400">
                ...
                <code className="mx-1 px-2 py-0.5 bg-neutral-900 rounded text-gold-500">yourleague.beerleaguehockey.ca</code>.
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400">
                ...
                <code className="mx-1 px-2 py-0.5 bg-neutral-900 rounded text-gold-500">yourleague.com</code>)
