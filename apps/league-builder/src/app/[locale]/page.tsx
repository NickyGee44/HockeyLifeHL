...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="relative overflow-hidden min-h-screen">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-4 lg:px-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/signup"
              className="px-4 py-2 text-sm font-medium bg-gold-500 text-black rounded-lg hover:bg-gold-400 transition-colors"
            >
              {t('auth.signup')}
            </Link>
          </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg lg:text-2xl text-neutral-200 mb-10 max-w-2xl mx-auto drop-shadow-md">
              The complete platform for managing your hockey league. Teams, schedules, standings, and more.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gold-500 text-black font-bold rounded-xl hover:bg-gold-400 transition-all hover:scale-105 shadow-lg shadow-gold-500/25"
              >
                Start Free Trial
      ...
      <div className="bg-neutral-900 py-8 border-y border-gold-500/20 overflow-hidden">
        <div className="flex items-center justify-center gap-4 mb-4">
          <div className="h-px flex-1 max-w-[100px] bg-gradient-to-r from-transparent to-gold-500/50" />
          <p className="text-sm font-medium text-neutral-400 uppercase tracking-wider">
            Trusted by leagues across Canada
          </p>
          <div className="h-px flex-1 max-w-[100px] bg-gradient-to-l from-transparent to-gold-500/50" />
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-white mb-4">
              ...
              <span className="text-gold-500">dominate</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group p-8 rounded-2xl bg-neutral-900/50 border border-gold-500/20 hover:border-gold-500/50 transition-all hover:-translate-y-1">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-gold-500/20 to-gold-500/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
      ...
      <div className="px-6 py-24 lg:px-12 bg-gradient-to-b from-neutral-950 to-neutral-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-neutral-400 mb-8 max-w-xl mx-auto">
            Join hundreds of hockey leagues already using HockeyLifeHL to streamline their operations.
          </p>
          <Link
            href="/signup"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gold-500 text-black font-bold rounded-xl hover:bg-gold-400 transition-all hover:scale-105 shadow-lg shadow-gold-500/25"
      ...
      {/* Footer */}
      <footer className="px-6 py-8 lg:px-12 bg-neutral-900 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-neutral-500">
            &copy; {new Date().getFullYear()} HockeyLifeHL. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
