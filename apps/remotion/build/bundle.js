...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "@hockey-life/remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_hockey_life_remotion"] = self["webpackChunk_hockey_life_remotion"] || [];
...
const BRAND = {
  bg: "#060B14",
  surface: "rgba(14, 23, 38, 0.82)",
  surfaceStrong: "rgba(11, 17, 28, 0.94)",
  line: "rgba(255, 255, 255, 0.1)",
  cyan: "#4FD8FF",
  cyanMuted: "rgba(79, 216, 255, 0.18)",
  blue: "#6C7CFF",
  gold: "#D4AF37",
  green: "#34D399",
  red: "#FB7185",
...
const sceneVisibility = (frame, durationInFrames, enterFrames = 18, exitFrames = 18) => {
  const enter = (0,cjs.interpolate)(frame, [0, enterFrames], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const exit = (0,cjs.interpolate)(
    frame,
...
const RinkBackdrop = () => {
  ...
  const drift = (0,cjs.interpolate)(frame, [0, 900], [0, -80], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    ...
    {
      style: {
        background: "radial-gradient(circle at top, rgba(108,124,255,0.22), transparent 34%), radial-gradient(circle at 20% 20%, rgba(79,216,255,0.18), transparent 26%), linear-gradient(180deg, #08101B 0%, #060B14 55%, #04070D 100%)"
      },
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...
                  inset: 220,
                  borderRadius: 48,
                  border: `2px solid rgba(79, 216, 255, 0.2)`
                }
              }
            ),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...
                  height: 720,
                  borderRadius: "50%",
                  border: `2px solid rgba(79, 216, 255, 0.22)`,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              alignItems: "center",
              justifyContent: "center",
              boxShadow: `0 20px 60px ${BRAND.shadow}`
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              cjs.Img,
              {
                src: (0,cjs.staticFile)("blh-logo.png"),
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...
        border: `1px solid ${BRAND.line}`,
        borderRadius: 40,
        boxShadow: `0 30px 90px ${BRAND.shadow}`,
...
const TitleBlock = ({ title, body, accent = BRAND.cyan }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 22 }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
...
const FloatingCard = ({ title, value, color, top, left, rotate, delay = 0 }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const entrance = (0,cjs.spring)({
    fps,
    frame: frame - delay,
    config: {
      damping: 16,
  ...
  const bob = Math.sin((frame + delay * 4) / 18) * 14;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    GlassPanel,
    {
      style: {
        ...
        width: 320,
        padding: 28,
        transform: `translateY(${(1 - entrance) * 120 + bob}px) rotate(${rotate}deg)`,
        opacity: entrance
      },
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
...
const MetricCard = ({ label, value, accent, style }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    GlassPanel,
    {
      style: {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
            style: {
...
const ShotCard = ({ src, label, style }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    GlassPanel,
    {
      style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", gap: 10 }, children: ["#FB7185", "#FBBF24", "#34D399"].map((swatch) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    width: 14,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...
        padding: 18,
        borderRadius: 56,
        background: "linear-gradient(180deg, #0E1724 0%, #05080E 100%)",
        border: `1px solid rgba(255,255,255,0.14)`,
        boxShadow: `0 35px 100px ${BRAND.shadow}`
      },
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
...
;// ./src/data/promo-script.ts

const hookCopy = {
  eyebrow: "FOR COMMISSIONERS",
  title: "Your league commissioner is using a spreadsheet from 2009.",
  subtitle: "Schedules in sheets. Scores by text. Payments hanging in the air."
};
const problemBullets = [
  "Group chats become the rulebook.",
  "Fee chasing eats your weeknights.",
  "Standings never feel fully trusted."
];
const featureBeats = [
  {
    label: "PAYMENTS",
    title: "Track fees without chasing anyone down.",
    body: "Balances, due dates, and paid status in one clean league view."
  },
  {
    label: "SCHEDULES",
    title: "One schedule. One source of truth.",
    body: "Game nights, rink times, and reminders stay synced for everyone."
  },
  {
    label: "STATS + SCORES",
    title: "Turn messy scoresheets into standings fast.",
    body: "Capture results, update stats, and give every team a clear record."
  },
  {
    label: "PLAYERS",
    title: "A mobile-friendly league experience people actually use.",
    body: "Public site, team pages, payments, schedules, and stats in one flow."
  }
];
const ctaCopy = {
  kicker: "BEERLEAGUEHOCKEY.CA",
  headline: "Stop running your league in a spreadsheet.",
  subhead: "See the platform at BeerLeagueHockey.ca or book a demo at demo.beerleaguehockey.ca.",
  primaryUrl: "demo.beerleaguehockey.ca",
  secondaryUrl: "BeerLeagueHockey.ca"
};
...
const SceneFrame = ({ duration, children }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = sceneVisibility(frame, duration);
  const lift = (0,cjs.interpolate)(opacity, [0, 1], [55, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    cjs.AbsoluteFill,
    {
      style: {
...
const HookScene = () => {
  const { fps } = (0,cjs.useVideoConfig)();
  const frame = (0,cjs.useCurrentFrame)();
  const emphasis = (0,cjs.spring)({
    fps,
    frame,
    config: { damping: 18, stiffness: 120 }
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 90, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 34 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: hookCopy.eyebrow, accent: BRAND.gold }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "h1",
        {
          style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          transform: `scale(${0.9 + emphasis * 0.12})`,
          boxShadow: `0 0 90px ${BRAND.cyanMuted}`
        }
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      FloatingCard,
      {
        title: "FINAL SCHEDULE V9.XLSX",
        value: "Nobody knows which one is final.",
        color: BRAND.red,
        top: 1030,
        left: 120,
        rotate: -8
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      FloatingCard,
      {
        title: "MIDNIGHT SCORE TEXT",
        value: "3-2? Maybe 4-2. Need to confirm.",
        color: BRAND.gold,
        top: 1340,
        left: 660,
        rotate: 7,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      FloatingCard,
      {
        ...
        value: "Five reminders. Two e-transfers. Zero clarity.",
        color: BRAND.cyan,
        top: 1410,
        left: 80,
        rotate: -3,
...
const ProblemScene = () => {
  const frame = (0,cjs.useCurrentFrame)();
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 120, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: "THE OLD WAY", accent: BRAND.red }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        TitleBlock,
        {
          title: "League admin should not feel like this.",
          body: "BLH is built for the exact moments where spreadsheets, texts, and payment chasing start breaking down.",
          accent: BRAND.red
        }
      )
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: problemBullets.map((bullet, index) => {
          const entrance = (0,cjs.interpolate)(frame, [index * 10, 24 + index * 14], [90, 0], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsx)(
            GlassPanel,
            {
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 24 }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: "GROUP CHATS / SHEETS / E-TRANSFERS / MANUAL STATS"
      }
    )
  ] });
};
const CalmScene = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 120, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: "THE BLH SHIFT", accent: BRAND.cyan }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        TitleBlock,
        {
          title: "BLH turns league admin chaos into calm.",
          body: "Payments, schedules, standings, stats, public league pages, and the player-facing experience all move into one clean operating system."
        }
      )
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            ShotCard,
            {
              src: "promo-dashboard.jpg",
              label: "Commissioner dashboard",
              style: { height: 620 }
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "grid", gridTemplateRows: "repeat(3, 1fr)", gap: 24 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Fees collected", value: "$18,450", accent: BRAND.green }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Games scheduled", value: "124", accent: BRAND.cyan }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Standings updated", value: "Real-time", accent: BRAND.gold })
          ] })
        ]
      }
    )
...
const PaymentsScene = () => {
  const beat = featureBeats[0];
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 120, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: beat.label, accent: BRAND.green }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(TitleBlock, { title: beat.title, body: beat.body, accent: BRAND.green })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "League balance", value: "$4,120 due", accent: BRAND.gold }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Auto-tracked", value: "42 paid", accent: BRAND.green }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(GlassPanel, { style: { padding: 30, minHeight: 240 }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.textMuted, fontFamily: TYPE.mono, fontSize: 20 }, children: "FOLLOW-UP LOAD" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.white, fontFamily: TYPE.display, fontSize: 62 }, children: "Down." }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.textMuted, fontFamily: TYPE.sans, fontSize: 30, lineHeight: 1.3 }, children: "Commissioners stop digging through messages for who has and has not paid." })
          ] }) }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(ShotCard, { src: "promo-dashboard.jpg", label: "Payments + league ops", style: { height: 240 } })
        ]
      }
    )
  ] });
...
const ScheduleScene = () => {
  const beat = featureBeats[1];
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 120, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: beat.label, accent: BRAND.cyan }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(TitleBlock, { title: beat.title, body: beat.body, accent: BRAND.cyan })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(GlassPanel, { style: { padding: 34 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
            ["Tue 8:30 PM", "Rangers vs Wolves", "Rinx North Pad"],
            ["Thu 9:45 PM", "Kings vs Jets", "Chesswood Arena"],
            ["Sun 6:15 PM", "Sharks vs Hawks", "Canlan York"]
          ].map(([time, match, venue]) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              style: {
                display: "grid",
              ...
              children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.cyan, fontFamily: TYPE.mono, fontSize: 22 }, children: time }),
                /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
                  /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.white, fontFamily: TYPE.sans, fontSize: 34, fontWeight: 700 }, children: match }),
                  /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.textMuted, fontFamily: TYPE.sans, fontSize: 28 }, children: venue })
                ] })
              ]
            },
            match
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "grid", gridTemplateRows: "repeat(3, 1fr)", gap: 24 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Reminder flow", value: "On time", accent: BRAND.cyan }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Schedule source", value: "Single", accent: BRAND.gold }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(GlassPanel, { style: { padding: 28 }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.textMuted, fontFamily: TYPE.mono, fontSize: 20 }, children: "CAPTAINS + PLAYERS" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: BRAND.white, fontFamily: TYPE.sans, fontSize: 34, fontWeight: 700, lineHeight: 1.15 }, children: 'No more "what time are we on tonight?"' })
            ] }) })
          ] })
        ]
      }
...
const StatsScene = () => {
  const beat = featureBeats[2];
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 120, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: beat.label, accent: BRAND.gold }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(TitleBlock, { title: beat.title, body: beat.body, accent: BRAND.gold })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        style: {
          marginTop: 90,
          display: "grid",
          gridTemplateColumns: "0.95fr 0.18fr 0.87fr",
          gap: 24,
          alignItems: "center"
        },
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(ShotCard, { src: "promo-scoresheet.jpg", label: "Messy input", style: { height: 620 } }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(GlassPanel, { style: { padding: 34, height: 620 }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 22 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Updated result", value: "4 - 2 Final", accent: BRAND.white }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Top line", value: "3 pts / 2 G / 1 A", accent: BRAND.gold }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(MetricCard, { label: "Standings", value: "Instantly refreshed", accent: BRAND.cyan })
          ] }) })
        ]
      }
    )
...
const PlayersScene = () => {
  const beat = featureBeats[3];
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(SceneFrame, { duration: 120, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: beat.label, accent: BRAND.blue }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(TitleBlock, { title: beat.title, body: beat.body, accent: BRAND.blue })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PhoneFrame, { src: "promo-team.jpg" }) }),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 26 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(FeaturePill, { label: "Public league site", accent: BRAND.blue }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(FeaturePill, { label: "Schedules + standings", accent: BRAND.cyan }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(FeaturePill, { label: "Payments + balances", accent: BRAND.green }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(FeaturePill, { label: "Team pages + stats", accent: BRAND.gold }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(ShotCard, { src: "promo-team.jpg", label: "League vibe + player-facing polish", style: { height: 320 } })
          ] })
        ]
      }
    )
...
const CtaScene = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const pulse = (0,cjs.spring)({
    fps,
    frame,
    config: { damping: 12, stiffness: 80 }
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneFrame, { duration: 90, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      style: {
        display: "flex",
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 30 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(Eyebrow, { label: ctaCopy.kicker, accent: BRAND.cyan }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "h2",
            {
              style: {
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "p",
            {
              ...
              children: ctaCopy.subhead
            }
          )
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 24 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            GlassPanel,
            {
              style: {
                padding: "30px 34px",
                background: `linear-gradient(135deg, ${BRAND.cyanMuted}, rgba(108,124,255,0.18))`,
                transform: `scale(${1 + pulse * 0.02})`
              },
              children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
                  /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: TYPE.mono, fontSize: 22, color: BRAND.textMuted }, children: "BOOK A DEMO" }),
                  /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: TYPE.display, fontSize: 58, color: BRAND.white }, children: ctaCopy.primaryUrl })
                ] }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: TYPE.display, fontSize: 70, color: BRAND.cyan }, children: "->" })
              ] })
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(GlassPanel, { style: { padding: "28px 34px" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: TYPE.mono, fontSize: 22, color: BRAND.textMuted }, children: "SEE THE PLATFORM" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: TYPE.display, fontSize: 52, color: BRAND.white }, children: ctaCopy.secondaryUrl })
            ] }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: TYPE.display, fontSize: 66, color: BRAND.gold }, children: "BLH" })
          ] }) })
        ] })
      ]
    }
...
const PromoVideo = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(cjs.AbsoluteFill, { style: { backgroundColor: BRAND.bg }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(RinkBackdrop, {}),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(BrandBug, {}),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 0, durationInFrames: 90, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HookScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 90, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ProblemScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 210, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(CalmScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 330, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PaymentsScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 450, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ScheduleScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 570, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StatsScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 690, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PlayersScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 810, durationInFrames: 90, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(CtaScene, {}) })
  ] });
};
