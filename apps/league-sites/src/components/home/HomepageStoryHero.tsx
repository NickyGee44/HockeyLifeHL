...
export function HomepageStoryHero({
  ...
  const slides = storySlides.length > 0 ? storySlides : [fallbackSlide];
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[560px] max-w-[1440px] items-end px-4 py-6 sm:px-5 md:min-h-[620px] md:px-6 md:py-8 xl:px-8 xl:py-10">
        <div className="grid w-full items-end gap-5 lg:grid-cols-[minmax(0,1.45fr)_340px] xl:grid-cols-[minmax(0,1.55fr)_360px]">
              ...
              <div className="mt-6 grid gap-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    {registrationSeason ? 'Register' : 'Scores'}
                  </Link>
                </div>
              </div>
            </motion.div>
