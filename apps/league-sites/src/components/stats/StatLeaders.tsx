        ...
        {metrics.map((metric) => {
          ...
          const leaders = [...rows]
            .map((row) => ({
              ...
              value: getMetricValue(row, metric.id),
            }))
          ...
          return (
            <div
              key={metric.id}
              className="rounded-[26px] border border-[var(--color-border)] bg-[var(--color-surface)]/70 p-4"
            >
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[var(--league-primary)]/12 text-[var(--league-primary)]">
                    <Icon className="h-4 w-4" />
                  </span>
                  <div>
                    <p className="text-sm font-bold text-[var(--color-text-primary)]">{metric.label}</p>
